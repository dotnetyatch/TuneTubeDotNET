            ...
            if (ModelState.IsValid)
               {
                ...
                string AuthKey = Cconfig.AppSetting["Auth:Key"];
                string AuthValue = Cconfig.AppSetting["Auth:Value"];
                using (var client = new HttpClient())
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(AuthKey, AuthValue);
